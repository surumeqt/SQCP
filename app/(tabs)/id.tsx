    ...
    <View className="flex-1 bg-[#312C51]">
        <Text className="text-[#F1AA9B] text-xl font-semibold text-center mt-6 mb-4">
          ...
          <ScrollView
            ...
            <StepsButton text='In case of lost ID Card:'/>
            <StepsButton text='1. Secure a Notarized Affidavit of Loss from an Attorney’s Office'/>
            <StepsButton text='2. Seek the approval of the head of office of the Student Discipline (Rm.122)'/>
            <StepsButton text='Pay the corresponding fee at the Cashier (Windows 1 or 2)'/>
            <StepsButton text='Proceed to Rm.315 for ID Card Printing'/>
          </ScrollView>
