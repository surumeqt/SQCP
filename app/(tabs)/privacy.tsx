...
export default function Privacy() {
    ...
    return (
    <View className="flex-1 bg-[#312C51] items-center p-4 ">
     ...
     <Text className='text-white font-semibold text-left w-full'>
        {'\u2022'} Name{"\n"}
        {'\u2022'} Contact Information{"\n"}
        {'\u2022'} Queue Details{"\n"}
        {'\u2022'} Location{"\n"}
     ...
     <Text className='text-[#F1AA9B] text-semibold text-left w-full mt-3 text-2xl'>2.How we use your Information:</Text>
     <Text className='text-white font-semibold text-left w-full'>
    ...
    <Text className='text-[#F1AA9B] text-semibold text-left w-full mt-3 text-2xl'>3.How we Protect your Data</Text>
         <Text className="text-white font-semibold text-left w-full ">
    ...
    <Text className='text-[#F1AA9B] text-semibold text-left w-full mt-3 text-2xl'>4.How we use your Information:</Text>
        <Text className='text-white font-semibold text-left w-full'>
    ...
    <Text className='text-[#F1AA9B] text-semibold text-left w-full mt-3 text-2xl'>5.How we Protect your Data</Text>
         <Text className="text-white font-semibold text-left w-full ">
